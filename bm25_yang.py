...
class TokenizedBM25:
    ...
    def _index_corpus(self, corpus: torch.Tensor) -> None:
        ...
        # print('_corpus', self._corpus.shape) # [total_batch_size, vocab_size]
        ...
        # print('_corpus_score', self._corpus_scores.shape) # [total_batch_size, vocab_size]
    ...
    def _score_batch(self, queries: torch.Tensor) -> torch.Tensor:
        ...
        # print('queries_bag', queries_bag.shape) # [batch_size, vocab_size]
        scores = queries_bag.float() @ self._corpus_scores.T # [batch_size x vocab_size x total_batch_size]
...
class BM25(TokenizedBM25):
    ...
    def index(self, documents: List[str]) -> None:
        ...
        while i < len(documents):
            ...
            # print(bags[-1].shape) # [bag_size, vocab_size]
